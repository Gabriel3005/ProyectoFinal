 ...
 * @author alexg
 */
public class JIF_Ingresar extends javax.swing.JInternalFrame {
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
       ...
       String user = txtusuario.getText();
            ...
            try {
                Connection con = Conexion2.obtenerConexion();
                ...
                if(rs.next()){
                    ...
                    if(pass.equals(p)){
                        ...
                        if(priv.equals("usuario")){
                          ...
                          FrmPrincipal.d_p_contenedor.add(us);
                          us.toFront();
                          us.setVisible(true);
                          this.dispose();
                        }else{
                            Supervisor sup = new Supervisor();
                             FrmPrincipal.d_p_contenedor.add(sup);
                             sup.toFront();
                             sup.setVisible(true);
                             this.dispose();
                        }
